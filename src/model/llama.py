...
class LlamaWrapper(object):
    ...
    def __call__(self, batch, output_log_likelihood=True, output_hidden_states=False, hidden_states_layers_to_output=(-1, -.5), output_only_last_token_hidden_states=False): # __call__ inside class means this class object can be be used as a function.
        with torch.no_grad():
